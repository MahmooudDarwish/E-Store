...
fun BrandProductsHeader(
    ...
    Row(
        ...
        ElevationCard(modifier = Modifier.padding(top = 20.dp, end = 20.dp)) {
            CustomIconButton(onClick = { onFilterClick() }, icon = ImageVector.vectorResource(id = R.drawable.ic_filter))
        }
    }
}
